...
# SECRET_KEY = 'o==s30d$(x5z1%knlz$k0_k1%r(c)m&83xash7m!0x31$w1^6w'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'pingpong_t',#config.get('database','DATABASE_NAME'),                     # Or path to database file if using sqlite3.
